        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">shakib.sami2.0@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+880 1700534241</p>
                </div>
              </div>
          ...
          >
            <form onSubmit={sendEmail} ref={form} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-black hover:text-blue-500 text-white py-3 px-6 rounded-lg font-semibold hover:bg-gray-800 hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
